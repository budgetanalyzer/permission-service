...
runtime utilities. Maven Central is used only for external dependencies and
explicitly excludes `org.budgetanalyzer`; internal artifacts resolve only from
Maven Local or the authenticated `service-common` GitHub Packages repository.
